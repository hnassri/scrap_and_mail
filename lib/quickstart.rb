...
msg.body = Text.new('coucou Max!', 'Mr. President - Coco Jambo (pour une bonne culture musicale!', 'charset' => 'us-ascii')
msg.from = {'marylis.stenger@gmail.com' => 'Coucou Man'}
msg.to   = {
    'maxime.smolis@gmail.com' => nil,
}
